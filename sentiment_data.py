...
def read_sentiment_examples(infile: str) -> List[SentimentExample]:
    ...
    """
    # print("File: sentiment_data.py: def read_sentiment_example(): Reading Sentiment Examples...")
    f = open(infile)
    exs = []
    for line in f:
        if len(line.strip()) > 0:
...
def read_blind_sst_examples(infile: str) -> List[List[str]]:
    ...
    """
    # print("File: sentiment_data.py: def read_blind_sst_examples(): Reading Sentiment Examples...")
